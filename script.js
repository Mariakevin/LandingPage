...
Open source maintainer. Available for freelance and full-time.`
    ...
    // CONSOLE EASTER EGG
    // ═══════════════════════════════════════════
    console.log('%c Alex Chen ', 'background: #FFF0F5; color: #FF6B35; font-size: 2rem; font-weight: bold; padding: 10px 20px; border: 3px solid #3D3D56;');
    ...
    console.log('%c Press ? for keyboard shortcuts ', 'background: #F0F4FF; color: #3D3D56; font-size: 0.8rem; padding: 5px 10px; border: 3px solid #3D3D56;');
